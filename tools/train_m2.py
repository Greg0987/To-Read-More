...
from captioning.data.dataloader_m2 import *
import skimage.io
import captioning.utils.eval_utils_m2 as eval_utils
import captioning.utils.misc as utils
from captioning.modules.rewards import init_scorer
from captioning.modules.loss_wrapper_m2 import LossWrapperM2
...
def train(opt):
    ...
    lw_model = LossWrapperM2(model, opt)
    ...
    try:
        while True:
            ...
            optimizer.zero_grad()
            # 模型前向传播
            model_out = dp_lw_model(obj_f, labels, masks, tags,
