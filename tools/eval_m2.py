...
from captioning.data.dataloader_ctx import *
from captioning.data.dataloaderraw import *
import captioning.utils.eval_utils_ctx as eval_utils
import argparse
...
replace = ['obj_dir', 'grid_dir', 'tag_dir', 'tags_h5' 'input_label_h5', 'input_json', 'batch_size', 'id']
ignore = ['start_from']
