...
def parse_opt():
    ...
    parser.add_argument('--new_features', action='store_true',
                    help='True if we want to use new features')
    parser.add_argument('--max_detections', type=int, default=50,
                    help='max number of detections per image')
    parser.add_argument('--topk', type=int, default=9,
                    help='topk tags for captioning')
    parser.add_argument('--obj_dir', type=str, default='data/oscar.hdf5',
                    help='path to the directory containing the preprocessed obj feats')
    parser.add_argument('--grid_dir', type=str, default='data/img_grids.hdf5',
                    help='path to the directory containing the preprocessed grid feats')
    parser.add_argument('--tag_dir', type=str, default='data/img_tags_top20.hdf5',    # default generated the top 120 tags
                    help='path to the directory containing the preprocessed tag feats')
    parser.add_argument('--tags_h5', type=str, default='data/tags_to_calculate.hdf5',
                        help='path to the directory containing the tags to calculate')
    parser.add_argument('--tags_num', type=int, default=100,
                        help='number of tags to calculate, max is 100')

    parser.add_argument('--d_reduction', type=str, default='fc',
                        help='the way to reduce the dimension of the attention of features, fc or sample or conv')
    ...
    # =====add by Greg=====
    parser.add_argument('--cov_reward_weight', type=float, default=1,
                    help='The reward weight from cov')
    parser.add_argument('--cl_reward_weight', type=float, default=1,
                    help='The reward weight from cl')
    parser.add_argument('--self_cider_reward_weight', type=float, default=1,
                    help='self cider reward')
    parser.add_argument('--cl_expected', type=float, default=20,
                    help='expected length of caption')
    ...
    parser.add_argument('--sc_beam_size', type=int, default=1,
                    help='')
    # ================ add by Greg
    parser.add_argument('--base_range', type=str, default='avg',
                    help='baseline method, options: avg|mid|mix')
    ...
    args.checkpoint_path = args.checkpoint_path or args.id
...
def add_eval_options(parser):
    ...
    parser.add_argument('--obj_dir', type=str, default='',
                    help='path to the directory containing the preprocessed dataset')
    parser.add_argument('--grid_dir', type=str, default='',
                    help='path to the directory containing the preprocessed dataset')
    parser.add_argument('--tag_dir', type=str, default='',    # default generated the top 120 tags
                    help='path to the directory containing the preprocessed dataset')
